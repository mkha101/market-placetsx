  ...
  return (
    <div>
      <div className="hidden sm:flex">
        <Select>
          <SelectTrigger className="w-[180px] cursor-pointer rounded-full bg-white rounded-r-none ">
      ...
      <div className="flex sm:hidden">
        <Select>
          <SelectTrigger className="w-[110px] bg-white cursor-pointer rounded-full rounded-r-none  ">
